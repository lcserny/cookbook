...
func TestConfig_GetMessage(t *testing.T) {
	...
	tests := []struct{
	...
	}{
		{
			...
			"something is NOT awesome with a certainty of 0 out of 10. Let me count the ways ",
		},
		{
			"base-case",
			fields{subject: "something", isAwesome: true},
			"something is awesome with a certainty of 0 out of 10. Let me count the ways ",
		},
	}
